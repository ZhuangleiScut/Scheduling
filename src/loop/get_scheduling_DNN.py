...
def schedule_DNN(i):
    ...
    for i in range(15):
        sheet1.write(i + 1, 0, i)
    # 保存Excel book.save('path/文件名称.xls')
    book.save('../../data/loop/DNN/0.' + str(i + 1) + '/scheduling_DNN.xls')

    data = pd.read_excel('../../data/loop/DNN/0.' + str(i + 1) + '/scheduling_DNN.xls')
    ...
    DataFrame(data).to_excel('../../data/loop/DNN/0.' + str(i + 1) + '/scheduling_DNN.xls')
    ...
    plt.savefig('../../data/loop/DNN/0.' + str(i + 1) + '/success.png')
    plt.show()
    ...
    plt.savefig('../../data/loop/DNN/0.' + str(i + 1) + '/time.png')
    plt.show()
    ...
    plt.savefig('../../data/loop/DNN/0.' + str(i + 1) + '/energys.png')
    plt.show()
    ...
    plt.savefig('../../data/loop/DNN/0.' + str(i + 1) + '/schedule_pro.png')
    plt.show()
