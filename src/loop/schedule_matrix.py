...
def get_load(pro, task_list, task_num):
    # 构造结果表
    ...
    book.save('../../data/loop/matrix/0.' + str(pro + 1) + '/load.xls')

    for i in range(equip_num):
        # 打开Excel文件
        data = pd.read_excel('../../data/raw/result' + str(i + 1) + '.xlsx', sheetname=0)
        load_record = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/load.xls')
        time_record = pd.read_excel(
            '../../data/loop/matrix/0.' + str(pro + 1) + '/predict_time_matrix0.' + str(pro + 1) + '.xls')
        ...
        for img in range(task_num):
            ...
            # 将更新写到新的Excel中
            DataFrame(load_record).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/load.xls')
...
def get_time_matrix(pro, task_list, task_num):
    ...
    # 保存Excel book.save('path/文件名称.xls')
    book.save('../../data/loop/matrix/0.' + str(pro + 1) + '/time_matrix.xls')

    for i in range(equip_num):
        # 打开原始数据文件
        # 打开Excel文件
        dt = pd.read_excel('../../data/raw/result' + str(i + 1) + '.xlsx')
        df = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/time_matrix.xls')
        for t in range(task_num):
            # 这里求deadline需要用tet真实值
            df['equip' + str(i + 1)][t] = dt['frame_process_time'][task_list[t]]
            DataFrame(df).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/time_matrix.xls')
        print(i)


def get_deadline(pro, task_list, task_num, proportion):
    # 打开Excel文件
    data = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/time_matrix.xls')
    for temp in range(task_num):
        ...
        # 将更新写到新的Excel中
        DataFrame(data).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/deadline.xls')
    temp += 1


def get_minload(pro, task_list, task_num):
    data = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/load.xls')
    deadline = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/deadline.xls')
    ...
    for i in range(task_num):
        ...
        # 将更新写到新的Excel中
        DataFrame(data).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/min_load.xls')
...
def get_weight(pro, task_list, task_num):
    ...
    # 保存Excel book.save('path/文件名称.xls')
    book.save('../../data/loop/matrix/0.' + str(pro + 1) + '/weight.xls')

    data = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/min_load.xls')
    weight = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight.xls')
    # 求30个任务的最小的负载
    for i in range(task_num):
        ...
        # 将更新写到新的Excel中
        DataFrame(weight).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight.xls')
        print(i)
...
def get_weight_sorted(pro, task_list, task_num):
    ...
    # 保存Excel book.save('path/文件名称.xls')
    book.save('../../data/loop/matrix/0.' + str(pro + 1) + '/weight_sorted.xls')

    weight = []
    # 根据权重对任务进行排序
    data = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight.xls')
    dt = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight_sorted.xls')
    ...
    for temp in range(task_num):
        ...
        data['sort'][temp] = ind
        # 将更新写到新的Excel中
        DataFrame(data).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight.xls')
        print(temp)
    ...
    DataFrame(dt).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight_sorted.xls')
...
def get_scheduling(pro, vm):
    ...
    # 打开文件
    data = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/weight_sorted.xls')
    success = 0
    scheduled = 0
    fail = 0
    times = []
    ...
    for k in range(task_num):
        ...
        # 没有调度
            ...
            data['mem_given'][k] = 0
            # 将更新写到新的Excel中
            DataFrame(data).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/schedule/' + str(vm) + '.xlsx')
...
def schedule_matrix(pro):
    ...
    # 根据任务列表求负载
    get_load(pro, task_list, task_num)
    get_time_matrix(pro, task_list, task_num)
    # 从time_matrix中获取deadline,按照比例
    get_deadline(pro, task_list, task_num, proportion)
    get_minload(pro, task_list, task_num)
    get_weight(pro, task_list, task_num)
    get_weight_sorted(pro, task_list, task_num)
    ##################################################
    # 虚拟机个数
    vm = 10
    successes = []
    ...
    for i in range(15):
        sheet1.write(i + 1, 0, i)
    # 保存Excel book.save('path/文件名称.xls')
    book.save('../../data/loop/matrix/0.' + str(pro + 1) + '/scheduling_matrix.xls')

    data = pd.read_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/scheduling_matrix.xls')
    ...
    DataFrame(data).to_excel('../../data/loop/matrix/0.' + str(pro + 1) + '/scheduling_matrix.xls')
    ...
    plt.savefig('../../data/loop/matrix/0.' + str(pro + 1) + '/success.png')
    plt.show()
    ...
    plt.savefig('../../data/loop/matrix/0.' + str(pro + 1) + '/time.png')
    plt.show()
    ...
    plt.savefig('../../data/loop/matrix/0.' + str(pro + 1) + '/energys.png')
    plt.show()
    ...
    plt.savefig('../../data/loop/matrix/0.' + str(pro + 1) + '/schedule_pro.png')
    plt.show()
