...
if __name__ == '__main__':
    ...
    data2 = pd.read_excel(path + 'group' + str(group) + '/' + str(propro) + '/DNN/scheduling_DNN.xls')
    data3 = pd.read_excel(path + 'group' + str(group) + '/' + str(propro) + '/matrix/scheduling_matrix.xls')
    # data4 = pd.read_excel('group' + str(group) + '/real/scheduling_real.xls')
    ...
    plt.savefig('../../data/line/VM_time_1.png')
    plt.show()
    ...
    plt.savefig('../../data/line/VM_num_1.png')
    plt.show()
    ...
    plt.savefig('../../data/line/VM_pow_1.png')
    plt.show()
    ...
    plt.xlabel('num_vm')
    plt.legend(['real', 'predict', 'matrix'], loc='upper left')
    plt.savefig('../../data/line/VM_pro_1.png')
    plt.show()